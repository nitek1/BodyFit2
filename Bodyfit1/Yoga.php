...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1 style="color: white;">YOGA</h1>
            <p>Equilíbrio entre corpo e mente</p>
        </div>
    </section>

    <!-- Seção de Aulas -->
    <section class="section">
        <h2 style="text-align: center; margin-bottom: 2rem; color: white;">AULAS DE YOGA</h2>
            ...
            <div class="classes-grid" style="justify-content: center;">
                ...
                <div class="class-card">
                    <div class="image-container">
                        <div class="static-img" style="background-image: url('https://images.unsplash.com/photo-1544367567-0f2fcb009e0b')"></div>
                ...
                <div class="class-card">
                    <div class="image-container">
                        <div class="static-img" style="background-image: url('https://images.unsplash.com/photo-1545205597-3d9d02c29597')"></div>
                        <div class="hover-gif" style="background-image: url('')"></div>
                    </div>
                    <div class="schedule">
                        <h3>Yoga Restaurativo</h3>
                        <p>Seg e Qua: 14h - 15h</p>
                        <form method="POST" action="reserva.php" class="reserve-form">
                ...
                <div class="class-card">
                    <div class="image-container">
                        <div class="static-img" style="background-image: url('https://images.unsplash.com/photo-1545389336-cf090694435e')"></div>
                        <div class="hover-gif" style="background-image: url('')"></div>
                    </div>
                    <div class="schedule">
                        <h3>Power Yoga</h3>
